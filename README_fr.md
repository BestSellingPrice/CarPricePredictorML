...
#### API
Pour utiliser l'API de `CarPricePredictorML`, l'URL, l'en-tête et le corps JSON suivants peuvent être utilisés:
...
* [AngularJS] (https://angularjs.org/) - Le cadre d'interface utilisateur utilisé.
* [Bootstrap] (https://getbootstrap.com/) - Le cadre d'interface utilisateur utilisé.